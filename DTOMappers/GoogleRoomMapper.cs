...
{
	public class GoogleRoomMapper:IMapper
	{
        public object Map(object source)
        {
            ...
            return new GoogleRoomDTO
            {
                GoogleRoomId = googleRoom.GoogleRoomId,
                RoomCategory = googleRoom.RoomCategory,
                MaxOccupancy = googleRoom.MaxOccupancy
            };
        }
    }
}
